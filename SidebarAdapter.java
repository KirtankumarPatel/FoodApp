    ...
    private static void performClick(Context ctx,DrawerLayout drawer,String title){
        ...
        switch (title) {
            ...
            case "Contact Us": {
                ...
                c.setData(Uri.parse("https://foodforyou.blogspot.com/p/contact.html"));
                ctx.startActivity(c);
                break;
            }
            case "Rate Us": {
            ...
            case "Terms and Conditions": {
                Intent policy = new Intent(Intent.ACTION_VIEW);
                policy.setData(Uri.parse("https://foodforyou.blogspot.com/p/terms-and-conditions.html"));
                ctx.startActivity(policy);
                break;
            }
            case "About Us": {
                Intent policy = new Intent(Intent.ACTION_VIEW);
                policy.setData(Uri.parse("https://foodforyou.blogspot.com"));
                ctx.startActivity(policy);
                break;
            }
        }
